...
////    private var liveData: RESpeckLiveData? = null
//
//    var model = "respeck_cnn-lstm_class14_64_n_7879.tflite"
//    //    var classCount = 5
//    var classCount = 14
//    var featureCount = 6
//    //    var windowWidth = 50
...
//    @Throws(IOException::class)
//    private fun loadModelFile(model: String): MappedByteBuffer {
//        val fileDescriptor = this.assets.openFd("respeck_cnn-lstm_class14_64_n_7879.tflite")
//        val fileInputStream = FileInputStream(fileDescriptor.fileDescriptor)
//        val fileChannel = fileInputStream.channel
//        val startOffSets = fileDescriptor.startOffset
//        val declaredLength = fileDescriptor.declaredLength
...
//
////                    proxy
////                    if ((predictedLabel=="Climbing stairs")  || (predictedLabel=="Descending stairs")) {
////                        val myLong: Double = value!!.getDouble("Stairs") as Double
////                        act_val["Stairs"] = (myLong + 2.5)
////                        store!!.collection("users").document(userID!!)
////                            .set(act_val, SetOptions.merge())
////                    }
//
////                    if (predictedLabel=="Running") {
////                        val label = String.format("Running")
////                        output.text = label
//////                        val myLong: Double = value!!.getDouble("Running") as Double
//////                        act_val["Running"] = (myLong + 2.5)
//////                        store!!.collection("users").document(userID!!)
...
////                    }
////                    else if (predictedLabel=="Walking at normal speed") {
////                        val label = String.format("Walking")
////                        output.text = label
//////                        val myLong: Double = value!!.getDouble("Walking") as Double
//////                        act_val["Walking"] = (myLong + 2.5)
//////                        store!!.collection("users").document(userID!!)
//////                            .set(act_val, SetOptions.merge())
////                    }
////                    else if ((predictedLabel=="Lying down right") || (predictedLabel=="Lying down left") ||
////                        (predictedLabel=="Lying down on back") || (predictedLabel=="Lying down on stomach")) {
////                        val label = String.format("Lying down")
//////                        output.text = label
//////                        val myLong: Double = value!!.getDouble("Lying down") as Double
//////                        act_val["Lying down"] = (myLong + 2.5)
//////                        store!!.collection("users").document(userID!!)
...
//class RespeckPage : AppCompatActivity() {
//
//    val ESSENTIAL_4_LABELS = arrayOf(
//        "Lying down",
//        "Running",
//        "Sitting,Standing",
//        "Walking"
...
////    private var liveData: RESpeckLiveData? = null
//
//    var model = "respeck_lstm_essential4_64_n_9867.tflite"
//    //    var classCount = 5
//    var classCount = 4
//    var featureCount = 6
//    //    var windowWidth = 50
...
//    @Throws(IOException::class)
//    private fun loadModelFile(model: String): MappedByteBuffer {
//        val fileDescriptor = this.assets.openFd("respeck_lstm_essential4_64_n_9867.tflite")
//        val fileInputStream = FileInputStream(fileDescriptor.fileDescriptor)
//        val fileChannel = fileInputStream.channel
//        val startOffSets = fileDescriptor.startOffset
//        val declaredLength = fileDescriptor.declaredLength
...
//        Log.i("is it","causing problem5")
//        if (maxIndex != -1) {
//            val predictedLabel = ESSENTIAL_4_LABELS[maxIndex]
//            val confidence = maxValue * 100
//            val label = String.format("%s", predictedLabel)
//            output.text = label
//
